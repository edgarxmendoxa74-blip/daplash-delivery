        ...
        <div className="min-h-screen bg-[#F8F9FC] flex font-outfit">
            ...
            <aside className="hidden lg:flex flex-col w-80 bg-white border-r border-gray-100 p-8 pt-10">
                ...
                <nav className="flex-1 space-y-2">
                    ...
                    <SidebarLink icon={<Utensils size={20} />} label="Menu Items" active={activeTab === 'menu'} onClick={() => setActiveTab('menu')} />
                    ...
                    <div className="fixed inset-0 z-[200] lg:hidden">
                        ...
                        <motion.aside initial={{ x: '-100%' }} animate={{ x: 0 }} exit={{ x: '-100%' }} className="absolute inset-y-0 left-0 w-80 bg-white p-8 flex flex-col" >
                            ...
                            <nav className="space-y-2 mb-auto">
                                ...
                                <SidebarLink icon={<Utensils size={20} />} label="Menu Items" active={activeTab === 'menu'} onClick={() => { setActiveTab('menu'); setMobileMenuOpen(false); }} />
            ...
            <main className="flex-1 flex flex-col min-w-0">
                <header className="h-20 bg-white border-b border-gray-100 flex items-center justify-between px-6 lg:px-12 sticky top-0 z-[100]">
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        {(activeTab === 'faqs' || activeTab === 'stores' || activeTab === 'menu') && (
                            <button
                                onClick={() => {
                                    ...
                                    if (activeTab === 'faqs') {
                                        ...
                                        setEditingItem({ name: '', description: '', price: 0, category: 'Pizza', image_url: '', store_id: stores[0]?.id || '', order_index: menuItems.length });
                                    }
                            ...
                            >
                                ...
                                <span>NEW {activeTab === 'faqs' ? 'FAQ' : activeTab === 'menu' ? 'ITEM' : 'STORE'}</span>
                            </button>
                        )}
                    </div>
                </header>
                                            ...
                                            <div className="grid grid-cols-2 gap-4">
                                                <div>
                                                    ...
                                                    <input 
                                                        ...
                                                        className="w-full p-4 bg-gray-50 border border-gray-100 rounded-2xl font-bold outline-none focus:ring-2 focus:ring-brand-accent transition-all" 
...
const ItemCard = ({ title, description, imageUrl, onEdit, onDelete }) => (
    <div className="bg-white p-6 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-xl transition-all group overflow-hidden flex flex-col">
        {imageUrl && (
        ...
        <h4 className="text-xl font-black text-brand-charcoal mb-2 tracking-tight uppercase truncate">{title}</h4>
        <p className="text-gray-500 text-sm mb-6 line-clamp-2 font-medium flex-1 whitespace-pre-wrap">{description}</p>
