...
const Header = () => {
    ...
    return (
        <header className={`fixed w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-white/80 backdrop-blur-lg shadow-md py-3' : 'bg-transparent py-5'}`}>
            <div className="container mx-auto px-6 flex justify-between items-center">
                <a href="#" className="flex items-center space-x-2 sm:space-x-3 group">
                    <div className="relative w-8 h-8 sm:w-10 sm:h-10 overflow-hidden rounded-full border-2 border-daplash-yellow shadow-sm transition-transform group-hover:scale-110">
                        <img
                    ...
                    <span className="text-lg sm:text-xl font-black tracking-tight text-daplash-dark whitespace-nowrap">
                        DAPLASH <span className="text-daplash-blue">DELIVERY</span>
                    </span>
                </a>
                ...
                <div className="md:hidden flex items-center">
                    <button className="p-2 text-daplash-dark" onClick={() => setMobileMenuOpen(!mobileMenuOpen)}>
            ...
            {mobileMenuOpen && (
                <div className="md:hidden absolute top-0 left-0 w-full h-screen bg-white z-[60] py-20 px-6 flex flex-col space-y-6">
                    <button className="absolute top-5 right-6 p-2 text-daplash-dark" onClick={() => setMobileMenuOpen(false)}>
                        <X size={32} />
                    </button>
                    <a
                        ...
                        className="bg-daplash-yellow text-daplash-dark p-6 rounded-2xl text-2xl font-black flex items-center justify-center space-x-3 shadow-lg shadow-daplash-yellow/20"
                    ...
                    <div className="mt-auto pb-10 flex border-t pt-10 border-gray-100">
                        <a href="https://m.me/100064173395989" target="_blank" rel="noopener noreferrer" className="flex flex-col space-y-2 group">
                            ...
                            <p className="text-xl font-black text-daplash-dark group-hover:text-daplash-blue transition-colors">FB MESSENGER</p>
                        </a>
                    </div>
                </div>
            )}
