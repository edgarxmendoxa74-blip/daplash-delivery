...
import { ArrowLeft, MapPin, User, Package, Phone, Copy, MessageSquare, Plus, Minus, Navigation, AlertCircle } from 'lucide-react';
            ...
            <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100">
                ...
                <div className="p-8 space-y-8">
                    ...
                    <div className="pt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <button
                            onClick={copyToClipboard}
                            className="w-full py-3 bg-white border-2 border-brand-primary text-brand-primary rounded-xl font-black text-sm hover:bg-brand-primary hover:text-white transition-all transform hover:-translate-y-1 shadow-md shadow-brand-primary/10 flex items-center justify-center gap-2"
                        >
                        ...
                        <button
                            ...
                            className="w-full py-3 bg-brand-primary text-white rounded-xl font-black text-sm hover:bg-green-700 transition-all transform hover:-translate-y-1 shadow-lg shadow-brand-primary/30 flex items-center justify-center gap-2 disabled:opacity-50"
                        >
